    ...
    <div class="row mt-5">
        <div class="col-md-12">
            ...
            <div class="alert alert-success alert-dismissible">
              ...
              <strong><?php echo htmlspecialchars(urldecode($_GET['message']), ENT_QUOTES, 'UTF-8'); ?></strong>
            </div>
            <?php
            }
            ?>
		...
		<div class="col-md-4">
			<ul class="nav flex-column nav-pills">
                ...
                <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" id="page-server" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Advanced servers</a>
